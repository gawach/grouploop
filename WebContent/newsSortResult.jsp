...
<c:forEach var="e" items="${SELECT_REAL}">
<tr>
   <th id="tt">${e.updated_at_news}</th>
	<td><a href="DetailNewsServlet?idNews=${e.id_news}">${e.title_news}</a></td>
	<c:choose>
  ...
  <div class="py-2 w-100">
    <form action="NewsAllServlet">
					<nav aria-label="Page navigation example">
					  <ul class="pagination">
					    <li class="page-item">
					      <a class="page-link" href="NewsSortServlet" aria-label="Previous">
					    	...
					    	<c:choose>
					    		...
					    		<c:otherwise>
					    		 <li class="page-item">
						    			<a class="page-link" href="NewsSortServlet?page=${b}">${b}</a>
								    </li>
					    		</c:otherwise>
					    	</c:choose>
					    </c:forEach>
					    ...
					    <li class="page-item">
						    <a class="page-link" href="NewsSortServlet?page=${TOTAL_PAGE_NUM}" aria-label="Next">
...
<li class="menuimg menu2"><a href="company.html"><span>Company</span>会社概要</a></li>
<li class="menuimg menu3"><a href="service.html"><span>Service</span>サービスのご案内</a></li>
